...
@st.cache_resource
def carrega_modelo():
    # https://drive.google.com/file/d/1kqYDgF8QkbCKUOraRjSV3GSoMZVtkktn/view?usp=drive_link
    url = 'https://drive.google.com/uc?id=1kqYDgF8QkbCKUOraRjSV3GSoMZVtkktn'
...
def previsao(interpreter,image):
    ...
    interpreter.set_tesnor(input_details[0]['index'],image)

    interpreter.invoke()

    output_data = interpreter.get_tesnor(output_details[0]['index'])
